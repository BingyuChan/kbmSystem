...
var Base = /** @class */ (function () {
    function Base(options, handlers, statisticsLogger) {
        ...
        this.aborted = false;
        this.retryCount = 0;
        this.config = __assign({ useCdnDomain: true, disableStatisticsReport: false, retryCount: 3, checkByMD5: false, uphost: '', forceDirect: false, chunkSize: DEFAULT_CHUNK_SIZE, concurrentRequestLimit: 3 }, options.config);
